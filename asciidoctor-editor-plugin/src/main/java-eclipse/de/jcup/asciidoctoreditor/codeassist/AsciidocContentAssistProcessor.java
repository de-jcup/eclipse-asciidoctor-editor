...
public class AsciidocContentAssistProcessor extends SupportableContentAssistProcessor {
    ...
    public AsciidocContentAssistProcessor() {
        super(new AsciidocKeywordContentAssistSupport(getDefault()), new DynamicIncludeContentAssistSupport(getDefault()), new DynamicImageContentAssistSupport(getDefault()),
                new DynamicPlantumlContentAssistSupport(getDefault()), new DynamicDitaaContentAssistSupport(getDefault()));
    }
}