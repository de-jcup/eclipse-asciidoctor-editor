...
- Linked with xref shortcut <<test-target-link-internal-2,test-target-link-internal-2>> 
...
<<test-target-link-internal-3 not existing,Link to "test-target-link-internal-3 not existing">>
